      ...
      <Item.Group divided>
        <Item>
          ...
          <Item.Content>
            ...
            <Item.Extra>
              <Button primary inverted as='a' href="https://sawhite110.github.io/Horiseon-SSS-Inc/" target="_blank">
              Click Me
              </Button>
            </Item.Extra>
        ...
        <Item>
          ...
          <Item.Content>
            ...
            <Item.Description>
              This is my first portfolio project, from the beginning of the coding bootcamp.
            </Item.Description>
            <Item.Extra>
              <Button primary inverted as='a' href="https://sawhite110.github.io/My-Personal-Portfolio/" target="_blank">
              Click Me
              </Button>
            </Item.Extra>
          </Item.Content>
        ...
        <Item>
          ...
          <Item.Content>
            ...
            <Item.Description>
              This is the first team project, that allows users to search for fun anime.
            </Item.Description>
            <Item.Extra>
              <Button primary inverted as='a' href="https://sawhite110.github.io/Anime-of-the-Day/" target="_blank">
                Click Me
              </Button>
            </Item.Extra>
          </Item.Content>
